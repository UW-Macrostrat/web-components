  ...
  [3],
  {
    ...
    "./node_modules/css-loader/dist/cjs.js!./node_modules/stylus-loader/dist/cjs.js?!./src/hierarchy/hierarchy.module.styl":
      function (module, exports, __webpack_require__) {
        (exports = __webpack_require__(
          ...
          module.i,
          ".name-hierarchy{width:92%;padding-top:35px;max-width:700px;margin:0 auto}.hierarchy-container{border:1px solid #eee;cursor:pointer}.hierarchy-name{font-weight:bold;padding:7px}.hierarchy-link{text-decoration:none;color:#000}.hierarchy-link:hover{color:#900;text-decoration:none}.active-strat-name{background-color:rgba(153,0,0,0.3);border:2px solid rgba(153,0,0,0.3)}.not-active-strat-name{background-color:#fff}.hierarchy-children{margin-left:7px;padding-left:7px}.badge{background-color:#aaa;font-weight:200}",
          "",
        ]),
    ...
    "./src/hierarchy/hierarchy.stories.ts": function (
      ...
      function Hierarchy(props) {
        var className = props.active
          ? "active-strat-name"
          : "not-active-strat-name";
        return (
          console.log(props),
          h("div.hierarchy-container " + className, [
            h("div.hierarchy-name", [
              props.name,
              h("span.badge", [props.units]),
            ]),
            h.if(null != props.children && props.children.length > 0)(
              "div.hierarchy-children",
              [
      ...
      __webpack_exports__.default = {
        ...
        component: function Hello(props) {
          return Object(index_module.a)("div", props.name);
        },
        args: {
          name: "Rocks",
          children: [
            {
              ...
              active: !1,
              children: [
                { name: "Rhyolite", units: 2, active: !0 },
                { name: "Granite", units: 5, active: !1 },
              ],
            },
            {
              name: "Sedimentary",
              ...
              active: !1,
              children: [
                { name: "Limestone", units: 2, active: !1 },
                {
                  name: "Sandstone",
                  units: 5,
                  active: !1,
                  children: [{ name: "arkose", units: 2, active: !1 }],
                },
              ],
            },
          ],
      ...
      var HierarchyExample = function Template(args) {
        return Object(index_module.a)(Hierarchy, Object.assign({}, args));
      }.bind({});
      (HierarchyExample.args = {}),
        (HierarchyExample.parameters = Object.assign(
          { storySource: { source: "(args) =>\n  h(Hierarchy, { ...args })" } },
          HierarchyExample.parameters
        ));
    },
