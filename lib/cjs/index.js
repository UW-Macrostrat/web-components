            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.prev = 6;
                  _context2.next = 9;
                  return axios__default["delete"](itemRoute);
  ...
  function (_Component) {
    ...
    _createClass(DeleteButton, [{
      ...
      value: function render() {
        ...
        intent = core.Intent.DANGER;
        icon = 'trash';
        return h('div.delete-control', [h(core.Alert, {
          isOpen: alertIsShown,
        ...
        }, alertContent), h(core.Button, _objectSpread2({
          onClick: onClick,
          icon: icon,
          intent: intent
        }, rest))]);
...
var AuthorList, GeoDeepDiveSwatchInner, VolumeNumber;
