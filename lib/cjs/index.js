...
exports.APIProvider = function () {
  ...
  function (_Component) {
    ...
    _createClass(APIProvider, [{
      ...
      key: "runQuery",
      value: function runQuery(promise, route, url, method, opts) {
...
exports.AppToaster = core.Toaster.create();
...
__APIResultView = function () {
        ...
        return regeneratorRuntime.async(function getData$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                _context.next = 13;
                return regeneratorRuntime.awrap(get(route, params, opts));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 6;
                _context2.next = 9;
                return regeneratorRuntime.awrap(axios__default["delete"](itemRoute));
              ...
              case 13:
                ...
                return _context2.abrupt("return", exports.AppToaster.show({
                  message: message,
                  intent: intent
                }));
  ...
  __APIResultView.contextType = exports.APIContext;
...
exports.APIResultView = function APIResultView(props) {
  ...
  ctx = react.useContext(exports.APIContext);
...
var boundMethodCheck$2 = function boundMethodCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new Error('Bound instance method accessed before binding');
  }
};
...
function (_Component) {
  ...
  _createClass(StatefulComponent, [{
    ...
    value: function updateState(spec) {
      var newState;
      boundMethodCheck$2(this, StatefulComponent);
...
__InfiniteScrollResultView = function __InfiniteScrollResultView(props) {
  ...
  */
  ...
  var _useImmutableState = exports.useImmutableState({
    items: [],
    scrollId: null,
    count: null,
    error: null
  ...
  getInitialData = function getInitialData() {
    ...
    return regeneratorRuntime.async(function getInitialData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(get(route, params, _objectSpread2({
  ...
  loadNext = function loadNext() {
    ...
    return regeneratorRuntime.async(function loadNext$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            if (!(scrollId != null)) {
          ...
          case 3:
            _context2.next = 5;
            return regeneratorRuntime.awrap(get(route, {
              scroll_id: scrollId
            }, _objectSpread2({
              unwrapResponse: unwrapResponse
            }, opts)));
  ...
  exports.useAsyncEffect(getInitialData, [route, params]);
  main = null;
  ...
  function (_Component) {
    ...
    _createClass(DeleteButton, [{
      ...
      value: function render() {
        ...
        intent = core.Intent.DANGER;
        icon = 'trash';
        return h([h(core.Button, _objectSpread2({
          onClick: onClick,
          icon: icon,
          intent: intent
        }, rest)), h(core.Alert, {
...
exports.LinkButton = reactRouterDom.withRouter(function (props) {
  ...
  return h(core.AnchorButton, _objectSpread2({
    onClick: onClick
  }, rest));
});
...
exports.NavLinkButton = function NavLinkButton(props) {
  ...
  return h(reactRouterDom.NavLink, _objectSpread2({
    className: className
  }, rest));
};
...
exports.SaveButton = function SaveButton(props) {
  ...
  return h(core.Button, _objectSpread2({
    icon: icon,
...
exports.LinkCard = function LinkCard(props) {
  ...
  return h(reactRouterDom.Link, _objectSpread2({
    to: to,
    className: className
  }, rest));
};
  ...
  function (_Component) {
    ...
    _createClass(FileUploadComponent, [{
      ...
      value: function renderDropzone(_ref) {
        ...
        boundMethodCheck$3(this, FileUploadComponent);
...
var boundMethodCheck$4 = function boundMethodCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new Error('Bound instance method accessed before binding');
  }
};
  ...
  function (_Component) {
    ...
    _createClass(ModelEditButton, [{
      ...
      value: function render() {
        ...
        return h(exports.EditButton, _objectSpread2({
          isEditing: isEditing,
...
exports.ModelEditor = function () {
  ...
  function (_StatefulComponent) {
    ...
    _createClass(ModelEditor, [{
      ...
      key: "persistChanges",
      value: function persistChanges(spec) {
        var changeset, err, k, newModel, persistChanges, ret, updatedModel, v;
        return regeneratorRuntime.async(function persistChanges$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                boundMethodCheck$4(this, ModelEditor);
              ...
              case 20:
                _context.next = 22;
                return regeneratorRuntime.awrap(persistChanges(updatedModel, changeset));
...
function (_Component4) {
  ...
  _createClass(GDDReferenceCard, [{
    ...
    value: function render() {
      ...
      return h(exports.APIResultView, {
