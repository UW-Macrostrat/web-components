...
exports.useAPIResult = function useAPIResult(route, params) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return get(route, params, _objectSpread2({}, opts));

            case 2:
              res = _context2.sent;
              return _context2.abrupt("return", setResult(res));
...
exports.LinkCard = function LinkCard(props) {
  ...
  className = "link-card";
  inner = h(core.Card, _objectSpread2({}, rest));
...
var boundMethodCheck$3 = function boundMethodCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new Error('Bound instance method accessed before binding');
  }
};
