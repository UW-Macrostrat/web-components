import { createContext, Component, useContext, useState, useEffect } from 'react';
import h from 'react-hyperscript';
import { memoize, debounce } from 'underscore';
import axios, { post, get } from 'axios';
import { Toaster, Intent, ButtonGroup, Button, Spinner, NonIdealState, Alert, AnchorButton, Collapse, Tag, EditableText, Card } from '@blueprintjs/core';
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 6;
                _context2.next = 9;
                return regeneratorRuntime.awrap(axios["delete"](itemRoute));
...
export { APIConsumer, APIContext, APIProvider, APIResultView, APIViewConsumer, APIViewContext, AppToaster, AuthorList, CancelButton, CollapsePanel, ConfinedImage, DeleteButton, EditButton, EditableDateField, EditableMultilineText, FileUploadComponent, GDDReferenceCard, GeoDeepDiveRelatedTerms, GeoDeepDiveSwatchInner, GeoDeepDiveSwatchInnerBare, HTML, InfiniteScrollResultView, LinkButton, LinkCard, Markdown, ModelEditButton, ModelEditor, ModelEditorContext, NavLinkButton, PagedAPIView, SaveButton, StatefulComponent, buildQueryString, useAsyncEffect, useImmutableState, useModelEditor };
