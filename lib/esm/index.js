...
var APIResultPlaceholder, APIResultView, APIViewConsumer, APIViewContext, PagedAPIView, Pagination, __APIResultView,
...
__APIResultView = (function() {
  class __APIResultView extends Component {
    ...
    componentDidUpdate(prevProps) {
      ...
      lazyGetData = debounce(this.getData, this.props.minInterval);
      return lazyGetData();
    }
