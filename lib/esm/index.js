...
import { Toaster, Spinner, ButtonGroup, Button, NonIdealState, Intent, Alert, AnchorButton, Collapse, Card, Tag, EditableText } from '@blueprintjs/core';
  ...
  function (_Component) {
    ...
    _createClass(DeleteButton, [{
      ...
      value: function render() {
        ...
        intent = Intent.DANGER;
        icon = 'trash';
        return h('div.delete-control', [h(Alert, {
          isOpen: alertIsShown,
        ...
        }, alertContent), h(Button, _objectSpread2({
          onClick: onClick,
          icon: icon,
          intent: intent
        }, rest))]);
...
export { APIConsumer, APIContext, APIProvider, APIResultView, APIViewConsumer, APIViewContext, AppToaster, AuthorList, CancelButton, CollapsePanel, ConfinedImage, DeleteButton, EditButton, EditableDateField, EditableField, FileUploadComponent, GDDReferenceCard, GeoDeepDiveSwatchInner, HTML, LinkButton, LinkCard, Markdown, ModelEditor, ModelEditorContext, NavLinkButton, PagedAPIView, SaveButton, StatefulComponent, buildQueryString };
